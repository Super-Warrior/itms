...
function EOAssignCtrl($scope, $modal, $log, $http, config, common, configService, customerService, exportService, orderService, dateTimeHelper) {
   ...
   $scope.columns = [
      //"sWidth": 150 
        ...
        { "mData": "customerOrder2", "sTitle": "莲花运单号", "sWidth": 120 },
        { "mData": "customerOrder3", "sTitle": "莲花委托单号", "sWidth": 120 },
        { "mData": "matIID", "sTitle": "物料" },
        { "mData": "resID1", "sTitle": "包装编码" },//new
        { "mData": "resAmt1", "sTitle": "包装数量" },
        { "mData": "resAmtCS1", "sTitle": "箱型" },//new
        { "mData": "volWgt", "sTitle": "体积重" },
        { "mData": "totalVolWgt", "sTitle": "总体积重" },
        { "mData": "subPackNumner", "sTitle": "封号" },//new
        { "mData": "packNum", "sTitle": "箱号" },
        //{ "mData": "amt", "sTitle": "件数" },
        { "mData": "totalAmt", "sTitle": "总件数" },
   ...
   $scope.quickSearch = function () {
      var data = {
         ...
         ERType: $scope.ERType,
         customerOrder1: ($scope.customerOrder1 !== null && $scope.customerOrder1 !== undefined && $scope.customerOrder1 !== '')?$scope.customerOrder1.toString().split(","):[""],
         customerOrder2: ($scope.customerOrder2 !== null && $scope.customerOrder2 !== undefined && $scope.customerOrder2 !== '')?$scope.customerOrder2.toString().split(","):[""],
         customerOrder3: ($scope.customerOrder3 !== null && $scope.customerOrder3 !== undefined && $scope.customerOrder3 !== '')?$scope.customerOrder3.toString().split(","):[""],
         ERTag: $scope.ERTag,
         ...
         ResAmtCS3: "",
         EOID: "",
         reqDelDateS: $scope.reqDelDateS,
         reqDelDateE: $scope.reqDelDateE,
         pickERDateS: $scope.pickERDateS,
         pickERDateE: $scope.pickERDateE
      };
