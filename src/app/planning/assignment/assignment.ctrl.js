...
function EOAssignCtrl($scope, $modal, $log, $http, config, common, configService, customerService) {
  'use strict';
    ...
    $scope.detailConfig = {
        erDetail: true,
        timeLine: true /*, data: $scope.quickResult */
    };
    $scope.columns = [{
        'mData': 'requirementDetail.pk.erID',
        'sTitle': 'ER'
    }, {
        'mData': 'requirementDetail.pk.erITN',
        'sTitle': 'ERITN'
    }, {
        'mData': 'ertypeDesc',
        'sTitle': '类型'
    }, {
        'mData': 'requirement.erTag',
        'sTitle': '特殊'
    }, {
        'mData': 'depCustomerDesc',
        'sTitle': '发货方'
    }, {
        'mData': 'recCustomerDesc',
        'sTitle': '收货方'
    }, {
        'mData': 'requirement.customerOrder1',
        'sTitle': '客户订单号'
    }, {
        'mData': 'requirement.customerOrder2',
        'sTitle': '客户运单号'
    }, {
        'mData': 'requirement.customerOrder3',
        'sTitle': '客户出库号'
    }, {
        'mData': 'requirementDetail.matIID',
        'sTitle': '物料'
    }, {
        'mData': 'requirementDetail.packNum',
        'sTitle': '箱号'
    }, {
        'mData': 'requirementDetail.amt',
        'sTitle': '件数'
    }, {
        'mData': 'requirement.reqDelDate',
        'sTitle': '送达日期'
    }, {
        'mData': 'ertrtypeDesc',
        'sTitle': '方式'
    }, {
        'mData': 'ertrvendorDesc',
        'sTitle': '第三方'
    }];
    $scope.selectedSite = [];
