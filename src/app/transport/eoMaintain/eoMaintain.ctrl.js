...
function EOMaintainSearchCtrl($scope, $http, config, common, $modal, $log, eoMaintainService, configService, customerService, exportService, orderService) {
   ...
   $scope.updateEOTRVendor1 = function (item) {
      ...
      if (typeof (value) == "undefined" || value == null)
         return;
      $scope.queryOption.EOTRVendor1 = value;
   };
   $scope.updateEOTRVendor2 = function (item) {
      var value = item.key;
      if (typeof (value) == "undefined" || value == null)
         return;
      $scope.queryOption.EOTRVendor2 = value;
   };

   $scope.updateBP1 = function (item) {
      var value = item.key;
      if (typeof (value) == "undefined" || value == null)
         return;
      $scope.queryOption.BP1 = value;
   };
   $scope.updateBP2 = function (item) {
      var value = item.key;
      if (typeof (value) == "undefined" || value == null)
         return;
      $scope.queryOption.BP2 = value;
   };
   $scope.updateBP3 = function (item) {
      var value = item.key;
      if (typeof (value) == "undefined" || value == null)
         return;
      $scope.queryOption.BP3 = value;
   };
   ...
   $scope.eoMaintainSearch = function () {
       $scope.queryOption.EOTRVendor1 = ($scope.queryOption.EOTRVendor1T !== null && $scope.queryOption.EOTRVendor1T !== undefined && $scope.queryOption.EOTRVendor1T !== '')?$scope.queryOption.EOTRVendor1T.toString().split(","):[""];
       $scope.queryOption.EOTRVendor2 = ($scope.queryOption.EOTRVendor2T !== null && $scope.queryOption.EOTRVendor2T !== undefined && $scope.queryOption.EOTRVendor2T !== '')?$scope.queryOption.EOTRVendor2T.toString().split(","):[""];
