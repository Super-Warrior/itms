...
(function ($) {
   ...
   ColVis.prototype = {
      ...
      "_fnDrawCallback": function () {
         ...
         var addition = this.dom.buttons.length - aoColumns.length;
         for (var i = 0, iLen = aoColumns.length ; i < iLen ; i++) {
            var buttonToUpdate = this.dom.buttons[i + addition];
            if (buttonToUpdate !== null) {
               if (aoColumns[i].bVisible) {
                  $('input', buttonToUpdate).not(':disabled').attr('checked', 'checked');
                  $('input', buttonToUpdate).not(':disabled')[0].checked = true;
               }
               else {
                  $('input', buttonToUpdate).not(':disabled').removeAttr('checked');
               }
            }
         }
      },
      ...
      "_fnAddButtons": function () {
         ...
         nButton = this._fnDomAllColumnButton("所有列");
      ...
      "_fnDomColumnButton": function (i) {
         ...
         if (sTitle.indexOf("allResult") >= 0) {
            var element = $(sTitle).removeClass("allResult").removeAttr("checked")
               .attr("disabled", "disabled").attr("readonly", "readonly");
            sTitle = element.prop("outerHTML");
         }
         $(nSpan).html(
      ...
      "_fnDomAllColumnButton": function (sTitle) {
         var
             that = this,
         ...
         $(nSpan).html(
              '<span class="ColVis_radio"><input type="checkbox" checked="checked"></span>' +
              '<span class="ColVis_title">' + sTitle + '</span>');
         ...
         $(nButton).click(function (e) {
            ...
            for (var i in that.s.dt.aoColumns) {
