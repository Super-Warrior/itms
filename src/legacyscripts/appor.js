...
$(document).ready(function() {
	...
	$('#logout a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> 用户退出 <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : "用户登出操作将关闭所有任务，未保存任务信息将无法提交",
			buttons : '[NO][YES]'
