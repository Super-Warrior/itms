angular
    .module('itms.common')
    .controller('EODetailCtrl', ['$scope', '$modalInstance', 'common', 'eoDetailService', 'eoService', 'dateTimeHelper',
       'data', 'configData', EODetailCtrl]);

function EODetailCtrl($scope, $modalInstance, common, eoDetailService, eoService, dateTimeHelper, data, configData) {
   $scope.configData = configData;
   alert(JSON.stringify($scope.configData));
   activate();
